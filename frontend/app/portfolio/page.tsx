      ...
      <main className="flex-1 relative z-10 mx-auto max-w-[1440px] w-full px-6 py-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-6">
          ...
          <motion.div
            ...
            className="lg:col-span-2 rounded-2xl overflow-hidden border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 hover:border-gray-300 dark:hover:border-gray-700 transition-colors"
          >
            {/* Hero Section */}
              ...
              <div className="relative flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                ...
                <div>
                  ...
                  <motion.div
                    ...
                    className="text-4xl font-black tabular-nums text-gray-900 dark:text-white tracking-tight"
                  >
                    {isLoading ? (
                  ...
                  {!isLoading && totalNetWorth === 0 && (
                    ...
                    >
                      <Link
                        href="/"
                        className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-emerald-500 to-teal-500 text-white text-sm font-semibold rounded-lg hover:from-emerald-600 hover:to-teal-600 transition-all shadow-lg shadow-emerald-500/25 hover:shadow-emerald-500/40 hover:-translate-y-0.5"
                      >
                ...
                <motion.div
                  ...
                  className="bg-gray-50 dark:bg-gray-800/50 backdrop-blur-xl rounded-xl border border-gray-200 dark:border-gray-700 px-4 py-3 min-w-[260px] hover:bg-gray-100/50 dark:hover:bg-gray-800/70 transition-colors"
                >
                        ...
                        {pnl24h !== 0 && (
                          <motion.div
                            ...
                            className={cn(
                              ...
                              pnl24h >= 0 ? "text-emerald-500" : "text-rose-500"
                            )}
                          >
                            {pnl24h >= 0 ? <ArrowUpRight className="w-4 h-4" /> : <ArrowDownRight className="w-4 h-4" />}
                          </motion.div>
                        )}
                      ...
                      <div className="flex items-center gap-2">
                        {pnl7d !== 0 && (
                          <motion.div
                            ...
                            className={cn(
                              "w-4 h-4 flex items-center justify-center",
                              pnl7d >= 0 ? "text-emerald-500" : "text-rose-500"
                            )}
                          >
                            {pnl7d >= 0 ? <ArrowUpRight className="w-4 h-4" /> : <ArrowDownRight className="w-4 h-4" />}
                          </motion.div>
                        )}
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      {bestMarket ? (
                        <Link
                          ...
                          className="group/link flex items-center gap-1 text-sm font-semibold text-teal-600 dark:text-teal-400 hover:text-teal-500 dark:hover:text-teal-300 transition-colors"
            ...
            {/* Bottom Stats Grid */}
            <div className="bg-gray-50/50 dark:bg-gray-800/30 border-t border-gray-200 dark:border-gray-800 px-6 py-4">
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                <motion.div
                  ...
                  className="group p-3 rounded-xl hover:bg-white dark:hover:bg-gray-800/50 transition-all cursor-default"
                >
                  <div className="flex items-center gap-2 mb-1">
                    <div className="w-2.5 h-2.5 rounded-full bg-blue-500 group-hover:ring-4 group-hover:ring-blue-500/20 transition-all" />
                ...
                >
                  <div className="flex items-center gap-2 mb-1">
                    <div className="w-2.5 h-2.5 rounded-full bg-emerald-500 group-hover:ring-4 group-hover:ring-emerald-500/20 transition-all" />
                    <span className="text-[10px] font-semibold text-gray-400 uppercase tracking-wider">Realized Gains</span>
                  </div>
                  <div className="text-lg font-bold tabular-nums text-emerald-600 dark:text-emerald-400">{totalClaimed > 0 ? '+' : ''}{formatCurrency(totalClaimed)}</div>
                </motion.div>
                <motion.div
                  initial={{ opacity: 0, y: 10 }}
                  animate={{ opacity: 1, y: 0 }}
                ...
                >
                  <div className="flex items-center gap-2 mb-1">
                    <div className="w-2.5 h-2.5 rounded-full bg-purple-500 group-hover:ring-4 group-hover:ring-purple-500/20 transition-all" />
                ...
                <motion.div
                  ...
                  whileHover={{ scale: 1.02, y: -2 }}
                  className="group p-3 rounded-xl hover:bg-white dark:hover:bg-gray-800/50 transition-all cursor-default relative"
                >
                  <div className="flex items-center gap-2 mb-1">
                    <div className="w-2.5 h-2.5 rounded-full bg-amber-500 group-hover:ring-4 group-hover:ring-amber-500/20 transition-all" />
          ...
          <motion.div
            ...
            className="rounded-2xl bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 shadow-sm overflow-hidden hover:border-gray-200 dark:hover:border-gray-700 transition-colors"
          >
            {/* Header */}
            ...
            <div className="p-5">
              {/* Empty State for Allocation Card */}
              {totalNetWorth === 0 && !isLoading ? (
                <motion.div
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                ...
                >
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400 mb-1">No allocations yet</p>
