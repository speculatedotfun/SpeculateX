...
export function TopHoldersCard({
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-[24px] p-6 shadow-sm border border-gray-100 dark:border-gray-700 h-full flex flex-col relative overflow-hidden">
      ...
      {/* Improved Tabs */}
      <div className="flex bg-gray-100/50 dark:bg-gray-700/50 p-1.5 rounded-xl mb-6 relative z-10">
        <div
        ...
        {(['yes', 'no'] as const).map((tab) => (
          ...
          >
            ...
            } ${holderTab === tab ? 'opacity-100 animate-pulse' : 'opacity-0'}`} />
          </button>
        ))}
      </div>
    ...
    >
      <div className="flex items-center gap-3">
        ...
        <div className="relative">
          <div className={`w-8 h-8 rounded-full bg-gradient-to-br ${getGradient(holder.address)} flex items-center justify-center shadow-sm`}>
            {isTop3 ? (
